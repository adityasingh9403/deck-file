      ...
      <div className="px-6 sm:px-12 lg:px-24 pt-20 md:pt-24 z-10">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-10">
          <div>
            ...
            <h1 className="text-6xl sm:text-7xl lg:text-[100px] font-black text-[#0F2F4F] uppercase leading-[0.8] tracking-tighter mt-2">
              ALLI <span className="text-[#9E7C2E]">ANCE</span>
            </h1>
          </div>

          <div className="flex gap-12 border-l border-slate-100 pl-8 mb-4">
             <div className="flex flex-col">
                <span className="text-4xl lg:text-5xl font-black text-[#0F2F4F]">15<span className="text-[#9E7C2E]">+</span></span>
                <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Global Partners</span>
             </div>
             <div className="flex flex-col">
                <span className="text-4xl lg:text-5xl font-black text-[#0F2F4F]">06</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full h-full max-h-[500px]">
          {partners.map((partner, i) => (
            <motion.div
              ...
              className="flex items-center gap-6 p-6 border border-slate-100 rounded-2xl group transition-all duration-500 cursor-pointer shadow-sm hover:shadow-xl hover:border-[#9E7C2E]/20"
            >
              <div className="w-14 h-14 bg-white border border-slate-50 flex items-center justify-center rounded-xl text-slate-300 group-hover:text-[#9E7C2E] group-hover:bg-orange-50 transition-all duration-500 shadow-inner">
                {partner.icon}
              </div>
              
              <div className="flex-grow">
                <h3 className="text-sm font-black uppercase tracking-widest text-[#0F2F4F] mb-1 group-hover:translate-x-1 transition-transform">
                  {partner.name}
                </h3>
              ...
              <ChevronRight size={16} className="text-slate-200 group-hover:text-[#9E7C2E] opacity-0 group-hover:opacity-100 transition-all" />
            </motion.div>
          ))}
        </div>
      </div>
